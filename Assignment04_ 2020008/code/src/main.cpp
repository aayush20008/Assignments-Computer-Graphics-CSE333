...
int main(int, char**)
{
    ...
    Object *triangle = new Triangle(Vector3D(-4, -6, -10), Vector3D(4, -6, -10),Vector3D(0, 6, -10), m);
    Object *triangle2= new Triangle(Vector3D(-8, -10, -15), Vector3D(8, -10, -15),Vector3D(0, 10, -15), m);
